    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.tabs}>
                ...
                >
                    <Text style={[styles.tabText, filtre === 'general' && styles.tabTextActive]}>
                        Général
                    </Text>
                </TouchableOpacity>
                ...
                >
                    <Text style={[styles.tabText, filtre === 'semaine' && styles.tabTextActive]}>
                        Semaine
                    </Text>
                </TouchableOpacity>
                ...
                >
                    <Text style={[styles.tabText, filtre === 'jour' && styles.tabTextActive]}>
                        Jour
                    </Text>
                </TouchableOpacity>
            </View>
